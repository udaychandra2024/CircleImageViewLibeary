 ...
 */
package com.ScircleImageuday.circleimageLibeary;
...
public class CircleimageLibeary extends ImageView {
    ...
    public CircleimageLibeary(Context context) {
        super(context);

        init();
    }

    public CircleimageLibeary(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public CircleimageLibeary(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);

        TypedArray a = context.obtainStyledAttributes(attrs, com.ScircleImageuday.circleimagelibuc.R.styleable.CircleImageView, defStyle, 0);

        mBorderWidth = a.getDimensionPixelSize(com.ScircleImageuday.circleimagelibuc.R.styleable.CircleImageView_civ_border_width, DEFAULT_BORDER_WIDTH);
